    ...
    _createClass(Action, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { onClick: this.props.handleOptions, disabled: !this.props.hasOptions },
                    'What should i do?'
                )
            );
        }
    ...
    _createClass(Options, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { onClick: this.props.handleDeleteOptions, disabled: this.props.options.length < 1 },
                    'Remove Options'
                ),
